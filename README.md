...
Notice Tracker runs per-site on a multisite network — activate it on each subsite you want to manage. Network-wide auto-activation and shared notice storage across the network are not supported in 1.0.0.
